...
# element and the index of the largest element along a particular dimension of a tensor.
...
# We are now ready to train the model. Let's train for 10 epochs and look at the results.
...
# We've created a fairly sophisticated training and evaluation pipeline in this tutorial.
# Here's a list of the topics we've covered:
...
# There's a lot of scope to experiment here, and I encourage you to use the interactive nature of Jupyter to play around
# with the various parameters. Here are a few ideas:

#* Try making the validation set smaller or larger, and see how it affects the model.
#* Try changing the learning rate and see if you can achieve the same accuracy in fewer epochs.
#* Try changing the batch size. What happens if you use too high a batch size, or too low?
#* Modify the `fit` function to also track the overall loss and accuracy on the training set, and see how it compares
#       with the validation loss/accuracy. Can you explain why it's lower/higher?
#* Train with a small subset of the data, and see if you can reach a similar level of accuracy.
#* Try building a model for a different dataset, such as the [CIFAR10 or CIFAR100 datasets]
#  (https://www.cs.toronto.edu/~kriz/cifar.html).

#Here are some references for further reading:
#* For a more mathematical treatment, see the popular [Machine Learning]
#  (https://www.coursera.org/lecture/machine-learning/classification-wlPeP) course on Coursera. Most of the images used
#  in this tutorial series have been taken from this course.
#* The training loop defined in this notebook was inspired from [FastAI development notebooks]
#  (https://github.com/fastai/fastai_docs/blob/master/dev_nb/001a_nn_basics.ipynb) which contain a wealth of other
#  useful stuff if you can read and understand the code.
#* For a deep dive into softmax and cross entropy, see [this blog post on DeepNotes]
# (https://deepnotes.io/softmax-crossentropy).


# With this we complete our discussion of logistic regression, and we're ready to move on to the next topic:
